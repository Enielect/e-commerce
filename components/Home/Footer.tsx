  ...
  return (
    <div className="bg-Button h-[26rem] w-full">
      <div className="justify-between px-[8.5rem] flex py-[4rem]">
        <Separator first="Exclusive" space="space-y-[1rem]">
          <span className="title-20-medium">Subscribe</span>
          <div className="flex flex-col">
            <span>Get 10% off your first order</span>
            <span className="border flex border-white p-2 mt-1">
              <input
                className="bg-Button focus:border-none focus:outline-transparent outline-transparent border-none"
                type="text"
...
const Separator = ({
  ...
  return (
    <div className="flex flex-col">
      <span className="mb-[2rem] title-20-medium">{first}</span>
